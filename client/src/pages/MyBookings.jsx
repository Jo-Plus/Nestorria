...
import { assets, dummyBookingsData } from "../assets/data.js";
      ...
      <div className="flex flex-col gap-6">
        {bookings && bookings.length > 0 ? (
          bookings.map((booking) => (
            <div key={booking._id} className="bg-white ring-1 ring-slate-900/5 p-4 rounded-xl shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <div className="flex flex-col justify-between w-full">
                  ...
                  <div className="flex flex-wrap gap-x-8 gap-y-2">
                    <div className="flex items-center gap-x-2">
                      ...
                      <span className="text-sm bg-slate-100 px-2 py-0.5 rounded">{booking.guests} People</span>
                    </div>
                    <div className="flex items-center gap-x-2">
                      <span className="medium-14 text-gray-700">Total Price:</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 border-t border-slate-100 pt-4 mt-2">
                <div className="flex flex-col">
                  <span className="text-xs text-gray-400 uppercase tracking-wider">Booking ID</span>
                  <p className="text-sm font-mono text-slate-600 truncate">{booking._id}</p>
                </div>
                <div className="flex flex-col">
              ...
              <div className="flexBetween mt-6 pt-4 border-t border-slate-100">
                <div className="flex items-center gap-x-3">
                  ...
                  <div className={`flex items-center gap-2 px-3 py-1 rounded-full text-xs capitalize ${
                    booking.isPaid ? "bg-green-50 text-green-600 ring-1 ring-green-500/20" : "bg-yellow-50 text-yellow-600 ring-1 ring-yellow-500/20"
                  }`}>
                    <span className={`w-2 h-2 rounded-full ${booking.isPaid ? "bg-green-500" : "bg-yellow-500"}`} />
