    ...
    <div className="bg-gradient-to-r from-[#fffbee] to-white py-16 pt-28">
      <form className="flex flex-col items-center text-sm text-slate-800">
        ...
        <div className="max-w-96 w-full px-4">
          ...
          <button
            type="submit"
            className="flex font-bold cursor-pointer items-center justify-center gap-1 mt-5 bg-secondary hover:bg-secondary/90 text-black py-3.5 w-full rounded-full transition"
          >
            Submit Form
            <img
              src={assets.right}
