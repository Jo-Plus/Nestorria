      ...
      {property.images.map((pImg, index) => {
        ...
        return (
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-end text-white p-10 bg-black/40 opacity-0 group-hover:opacity-100 transition-all duration-300 rounded-2xl">
